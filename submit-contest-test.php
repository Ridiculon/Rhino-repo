				...
				<div id="content">
					<div id="splash">
						...
						if(strcmp(@$_SESSION['valid_user'],"") == 0){
							...
							echo "<p class=\"error\" style=\"font-size: 40px\">You need to be logged in to view this page.</p>";
						}else{
							echo "<p class=\"error\" style=\"font-size: 40px\">I am sorry but this functionality is not currently enabled.</p>";
						}
						?>
					</div>
				</div>
